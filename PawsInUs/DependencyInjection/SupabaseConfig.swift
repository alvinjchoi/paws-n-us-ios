...
struct SupabaseConfig {
    ...
    static let url: URL = {
        do {
            ...
            #if DEBUG
            print("Warning: Using hardcoded Supabase URL. Set SUPABASE_URL in Info.plist")
    ...
    static let anonKey: String = {
        do {
            ...
            // Fallback for development - remove in production
            #if DEBUG
            print("Warning: Using hardcoded Supabase anon key. Set SUPABASE_ANON_KEY in Info.plist")
